...
@section('titulo', 'Documentos de gestión')
@section('js')
...
<script src="{{ asset('js/sistema/documento_tipos.js') }}" type="text/javascript"></script>
@endsection
@section('contenido')
    ...
    <div class="container-xl">
        <div class="row row-cards">
            <div class="col-12">
                <div class="card">
                    <div id="t_principal">
                        <table id="t_documentos" class="table card-table table-vcenter text-nowrap datatable" width="100%">
                            <thead>
                                <tr>
                                    <th>ABREV.</th>
                                    <th>NOMBRE</th>
                                    <th title="DOCUMENTOS">DOC.</th>
                                    <th>ESTADO</th>
                                    <th>ACCIONES</th>     
                                </tr>
                            </thead>
