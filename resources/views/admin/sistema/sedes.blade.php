...
<script src="{{ asset('js/sistema/sedes.js') }}" type="text/javascript"></script>
@endsection
@section('contenido')
    ...
    <div class="container-xl">
        <div class="row row-cards">
            <div class="col-12">
                <div class="card">
                    <div id="t_principal">
                        <table id="t_sedes" class="table card-table table-vcenter text-nowrap datatable" width="100%">
                            <thead>
                                <tr>
                                    <th>ABREV.</th>
                                    <th>NOMBRE</th>
                                    <th>DIRECCIÓN</th>
                                    <th title="DEPENDENCIAS">DEP.</th>
                                    <th>ESTADO</th>
                                    <th>ACCIONES</th>     
                                </tr>
                            </thead>
        ...
        <div class="modal-content">
            ...
            <div id="form_editar" class="modal-body">  
                ...
                <div class="form-group">
                    ...
                    <textarea id="direccion" class="form-control mayuscula" rows="3"></textarea>
                </div>                            
            </div>   
