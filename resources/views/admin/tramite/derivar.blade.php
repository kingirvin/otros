...
@section('titulo', 'Derivar documento')
...
<script src="{{ asset('js/tramite/derivar_documento.js?v='.config('app.version')) }}" type="text/javascript"></script>
@endsection
@section('contenido')
...
<div class="page-body">
    <div class="container-lg">
        <div id="form-documento" class="row">            
            <div class="col-md-6">               
                <div class="card mb-3">
                    <ul class="nav nav-pills nav-pills-custom" data-bs-toggle="tabs">
                        <li class="nav-item">
                            <a href="#tabs-proveido" class="nav-link active" data-bs-toggle="tab">
                        ...
                        <li class="nav-item">
                            <a href="#tabs-referido" class="nav-link" data-bs-toggle="tab">
                        ...
                        <li id="buscar_archivo" class="nav-item ms-auto mt-1 mt-md-0" style="display: none;">
                            <button class="btn btn-secondary" onclick="buscar_archivo();">
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="tab-pane active show" id="tabs-proveido">
                                <div class="form-group form-required mb-3">
                                    <div class="form-label">Acciones</div>
                                    <div>
                                        @if(count($acciones)>0)
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <label class="form-check">
                                                    ...
                                                    <span class="form-check-label">{{$accion->orden}}. {{$accion->nombre}}</span>
                                                </label>
                                            </div>
                                            @endforeach
                                        </div>
                                ...
                                <div class="form-group form-required">
                                    <div class="form-label">Indicaciones</div>
                                    <textarea id="accion_otros" class="form-control mayuscula" rows="2"></textarea>                                  
                                </div>
                            </div>
                            <div class="tab-pane" id="tabs-referido">
            ...
            <div class="col-md-6">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4 form-group mb-3">
                                ...
                                <input type="text" class="form-control text-purple" value="T-{{$movimiento->tramite->codigo}}" disabled="">
                            </div>
                            <div class="col-md-8 form-group mb-3">
                                <label class="form-label">Documento</label>
                                <input type="text" class="form-control" value="{{$movimiento->documento->documento_tipo->abreviatura}} {{$movimiento->documento->numero}}" disabled="">
                            </div>
                        </div>
                        <div class="form-group mb-3">
                            <label class="form-label">Asunto</label>
                            <input type="text" class="form-control" value="{{$movimiento->documento->asunto}}" disabled="">
                        </div>
                        <div class="form-group mb-3">
                ...
                <div id="anexos_card" class="card mb-3" style="display: none;">
                    <div class="card-header">
                        <div class="w-100">
                            <div class="row align-items-center">
                              <div class="col">
