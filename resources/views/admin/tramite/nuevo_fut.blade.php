            ...
            <div class="col">
                <div>
                    <ol class="breadcrumb breadcrumb-alternate" aria-label="breadcrumbs">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Nuevo FUT</li>
                    </ol>
                </div>
                <h2 class="page-title">
                    FUT
                    ...
                    <div class="card-header">
                        <div class="w-100">
                            <div class="row row align-items-center">
                                <div class="col">
                                    <h3 class="card-title">FORMATO ÚNICO DE TRÁMITE(FUT)</h3>
                                </div>
                            </div>
                        </div>                        
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 form-group form-required mb-3">                                
                                <div class="form-label">Señor: UNIVERSIDAD NACIONAL AMAZONICA DE MADRE DE DIOS</div>                               
                            </div>
                            <div class="col-md-6 form-group form-required mb-3">   
