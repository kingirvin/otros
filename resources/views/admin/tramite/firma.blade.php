...
<script>
    ...
    const elArchivo = {{$archivo->id}};
    const firma_hojas = {!! $archivo->informacion !!};  
...
<script src="{{ asset('js/tramite/firmar_avanzado.js?v='.config('app.version')) }}" type="text/javascript"></script>
@endsection
@section('contenido')
            ...
            <div class="col">
                <div>
                    <ol class="breadcrumb breadcrumb-alternate" aria-label="breadcrumbs">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('admin/tramite/archivos') }}">Archivos</a></li>
...
@php
    $informacion = json_decode($archivo->informacion, true);   
@endphp
<div class="page-body">
    <div class="container-lg">
        <div class="row ">
            ...
            <div class="col-md-4">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <select id="num_pagina" class="form-select"> 
                              <option value="0">Primera página</option>
                              @if(count($informacion)>1)
                              <option value="1">Utlima página</option>
                              @endif
                            </select>
                        </div>
                        <div class="form-group mb-3">
                ...
                <div class="d-flex">
                    <a href="{{ url('admin/tramite/archivos') }}" class="btn btn-link flex-fill">Cancelar</a>
