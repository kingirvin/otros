            ...
            <div class="col">
                <div>
                    <ol class="breadcrumb breadcrumb-alternate" aria-label="breadcrumbs">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Constancias</li>
                    </ol>
                </div>
                <h2 class="page-title">
                    Validar constancias / certificados
                </h2>
            </div>            
        </div>
    </div>    
    <div class="row row-cards">
        <div class="col-md-4">
            <div class="card card-sm mb-3">
                <img src="{{ asset('img/codigo_constancia.png') }}" alt="" class="w-100 card-img">
            </div>
        </div>
        <div class="col-md-4">
            @if(session('error'))
            ...
            <form action="{{ url('consultas/constancias/validar') }}" method="POST" onsubmit="return guardar_todo(this);" >
                @csrf       
                <div class="card mb-3">
                    <div class="card-header">
                        <h3 class="card-title">Datos del constancia / certificado</h3>
                    </div>
                    <div class="card-body">
                        <div id="form_principal">
                            <div class="form-group form-required mb-3">
                                ...
                                <div class="input-group input-group-flat">
                                    ...
                                    <input id="codigo" type="text" name="codigo" class="form-control mayuscula validar_minimo:8 ps-0" placeholder="00000000" maxlength="8" autocomplete="off" autofocus>
                                </div>
                            </div>
                        </div>
